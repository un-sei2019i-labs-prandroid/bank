...
public class UserRepository {
    ...
    public static void createUsuario(Context context, int userid, String email, String password){
        ...
        content2.put(Utilidades.CAMPO_EMAIL, email);
        content3.put(Utilidades.CAMPO_PASSWORD,password);

        admin.execSQL("INSERT INTO "+ Utilidades.TABLA_USUARIO+" VALUES (" +content1+", "+ content2+", "+content3+")");
    }
